    ...
    <body>
       <%
           Class.forName("com.mysql.jdbc.Driver");
                ...
                String sql = "SELECT UserName FROM StaffMembers";
                ...
                while(rs.next())
                {
                    ...
                    if(UserName==username)
                    {
                        ...
                        <a href="updateprofile.jsp">go back and enter a valid user name</a>
                        <%
                    }
                }
                if(password!=confirmpassword)
                {
                     %>
                        ...
                        <a href="updateprofile.jsp">go back and enter a valid password and confirm password</a>
                     <%
                }
                else
                {
                ...
                String line = "INSERT INTO StaffMembers VALUES("
                        + "'" + MemberID + "',"
                        + "'" + username + "','"+password+"',"
                        + "'" + email+ "',"
                        + "'" + contact + "','"+name+")";
       ...
       %>
        <a href="updateprofile.jsp">Back</a>
    </body>
</html>
